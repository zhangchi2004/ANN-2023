...
# ADDED: Changed all load_cifar_2d to load_cifar_4d and import json
...
if __name__ == '__main__':
	...
	if args.is_train:
		...
		#ADDED
		with open("train_loss_list2.json", "w") as f:
			json.dump(train_loss_list, f)
		with open("train_acc_list2.json", "w") as f:
			json.dump(train_acc_list, f)
		with open("val_loss_list2.json", "w") as f:
			json.dump(val_loss_list, f)
		with open("val_acc_list2.json", "w") as f:
